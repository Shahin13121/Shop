...
namespace Shop11A.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            new Product{ Id = 1, Name = "Keyboard PGMT 11a", Description = "Keyboard PGMT 11a", Price = 500.11M, ImageUrl = "/images/t1.jpg" },
            new Product{ Id = 2, Name = "PC PGMT 11b", Description = "Super mega giga PC PGMT 11b", Price = 2000.11M, ImageUrl = "/images/t2.jpg" },
            new Product{ Id = 3, Name = "Mouse PGMT 12b", Description = "Mouse PGMT 12b", Price = 200.11M, ImageUrl = "/images/t3.jpg" },
